...
def build_layered_config(
    ...
    if user_path:
        try:
            ...
            logging.warning('Failed to load user config %s: %s', user_path, e)
    ...
    if workspace_root:
        ...
        if project_path:
            try:
                ...
                logging.warning('Failed to load project config %s: %s', project_path, e)
    ...
    if workspace_root:
        ...
        if local_path:
            try:
                ...
                logging.warning('Failed to load local config %s: %s', local_path, e)
